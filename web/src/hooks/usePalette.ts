...
export const PALETTES = [
  {
    id: 'zinc',
    label: 'Zinc',
    hint: 'Neutral cool gray (default)',
    swatch: ['#e4e4e7', '#71717a', '#27272a'],
  },
  {
    id: 'slate',
    label: 'Slate',
    hint: 'Blue-leaning gray',
    swatch: ['#e2e8f0', '#64748b', '#1e293b'],
  },
  { id: 'stone', label: 'Stone', hint: 'Warm gray', swatch: ['#e7e5e4', '#78716c', '#292524'] },
  {
    id: 'graphite',
    label: 'Graphite',
    hint: 'High-contrast charcoal',
    swatch: ['#e4e4e7', '#71717a', '#18181b'],
  },
  {
    id: 'sage',
    label: 'Sage',
    hint: 'Muted green-gray',
    swatch: ['#d5d9ce', '#6b7460', '#373d33'],
  },
  { id: 'forest', label: 'Forest', hint: 'Deep olive', swatch: ['#c5d3c1', '#557050', '#2e3d2d'] },
  {
    ...
    label: 'Ocean',
    hint: 'Deep blue-gray',
    swatch: ['#cdd9e8', '#5a7696', '#314054'],
  },
  { id: 'mist', label: 'Mist', hint: 'Soft cool blue', swatch: ['#d3e4f0', '#5f8fad', '#365063'] },
  {
    id: 'dusk',
    label: 'Dusk',
    hint: 'Muted indigo-gray',
    swatch: ['#d8d8eb', '#6f6f9a', '#3d3d55'],
  },
  {
    id: 'clay',
    label: 'Clay',
    hint: 'Earthy brown-gray',
    swatch: ['#e6d7cf', '#9a7260', '#574038'],
  },
] as const;
